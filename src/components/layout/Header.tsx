...
import { Bell, Search, Settings, ChevronDown, User, Moon, Sun, Globe, LogOut, Menu } from 'lucide-react'
  ...
  return (
    <header className="bg-white border-b border-gray-200 px-4 lg:px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        {/* Search */}
        <div className="flex items-center flex-1 max-w-md lg:max-w-lg ml-4 lg:ml-0">
